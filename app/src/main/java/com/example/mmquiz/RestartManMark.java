...
public class RestartManMark extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restart_man_mark);
    ...
    private void openManMark() {
        finish();
        Intent intent2=new Intent(this,Ambele.class);
